...
Comb0.05_ds <- lapply(1:nsim, function(i) CombData(data=dat,beta=0.05,nrep))
Comb0.1_ds <- lapply(1:nsim, function(i) CombData(data=dat,beta=0.1,nrep))
Comb0.5_ds <- lapply(1:nsim, function(i) CombData(data=dat,beta=0.5,nrep))
